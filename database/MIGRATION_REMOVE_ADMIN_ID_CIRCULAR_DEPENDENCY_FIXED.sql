...
-- VERSION CORRIGÉE : Suppression des policies dépendantes
-- =====================================================

-- =====================================================
-- ÉTAPE 0 : SUPPRIMER LES POLICIES DÉPENDANTES
-- =====================================================

-- Supprimer les policies sur notifications qui dépendent de admin_id
DROP POLICY IF EXISTS "Admin Groupe can view their group notifications" ON notifications;

-- Supprimer les policies sur expenses qui dépendent de admin_id
...
-- =====================================================
-- ÉTAPE 7 : RECRÉER LES POLICIES POUR NOTIFICATIONS
-- =====================================================

-- Policy : Admin Groupe peut voir les notifications de son groupe
...
USING (
  EXISTS (
    ...
    AND (
      ...
      OR
      -- Notifications pour son rôle
      notifications.recipient_role = 'admin_groupe'
      OR
...
-- =====================================================
-- ÉTAPE 8 : RECRÉER LES POLICIES POUR EXPENSES
-- =====================================================

-- Policy : Admin Groupe peut voir les dépenses de son groupe
...
-- Policy : Admin Groupe peut créer des dépenses pour son groupe
...
-- Policy : Admin Groupe peut modifier les dépenses de son groupe
...
-- Policy : Admin Groupe peut supprimer les dépenses de son groupe
...
-- =====================================================
-- ÉTAPE 10 : CRÉER UN TRIGGER POUR AUTO-ASSIGNER
-- =====================================================
...
-- Vérifier les policies sur school_groups
...
-- Vérifier les policies sur expenses
SELECT schemaname, tablename, policyname
FROM pg_policies
...
✅ RLS policies mises à jour (school_groups, notifications, expenses)
...
2. Admin Groupe (role='admin_groupe', school_group_id=<group_id>)
   ...
   → Voit les notifications de son groupe
   → Gère les dépenses de son groupe
*/
