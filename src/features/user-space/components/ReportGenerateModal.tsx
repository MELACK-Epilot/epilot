          ...
          <div className="bg-gradient-to-r from-[#2A9D8F]/10 to-blue-50 rounded-xl p-6 border border-[#2A9D8F]/20">
            <div className="flex items-start gap-4">
              ...
              {schoolInfo?.school.logo ? (
                <div className="h-20 w-20 rounded-lg bg-white p-2 border-2 border-[#2A9D8F]/20 flex items-center justify-center overflow-hidden shadow-sm">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      console.log('📍 Logo URL:', schoolInfo.school.logo);
                      // Fallback si l'image ne charge pas
                      (e.target as HTMLImageElement).style.display = 'none';
                      (e.target as HTMLImageElement).parentElement!.innerHTML = `
                        <div class="h-20 w-20 bg-gradient-to-br from-[#2A9D8F] to-[#238b7e] rounded-lg flex items-center justify-center">
                ...
                <div className="h-20 w-20 bg-gradient-to-br from-[#2A9D8F] to-[#238b7e] rounded-lg flex items-center justify-center shadow-md">
