/**
 * Composant Stats Cards pour la page Utilisateurs - VERSION GLASSMORPHISM PREMIUM
 * Style identique à la page Catégories avec cercle décoratif animé
 */

import { UsersIcon, UserCheck, UserX, UserMinus, TrendingUp } from 'lucide-react';
...
export const UsersStats = ({ stats, isLoading }: UsersStatsProps) => {
  if (isLoading) {
    return (
